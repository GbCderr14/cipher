          ...
          <nav className="nav">
            <div className="nav_list">
              <a href="#2" className="nav_link active">
                <i
                  className="bx bxs-home nav_icon"
                  style={{ color: "black" }}
                />
              ...
              <a href="#1" className="nav_link">
                <i
                  className="bx bxs-dashboard nav_icon"
                  style={{ color: "black" }}
                />
              ...
              <a href="#1" className="nav_link">
                <i
                  className="bx bxl-discord nav_icon"
                  style={{ color: "black" }}
                />
              ...
              <a href="#2" className="nav_link">
                <i
                  className="bx bxs-copy-alt nav_icon"
                  style={{ color: "black" }}
                />
              ...
              <a href="#2" className="nav_link">
                <i
                  className="bx bxs-copyright nav_icon"
                  style={{ color: "black" }}
                />
              ...
              <a href="#3" className="nav_link">
                <i
                  className="bx bx-sitemap nav_icon"
                  style={{ color: "black" }}
                />
